            ...
            <nav class="navbar navbar-expand-lg navbar-light bg-transparent">
                <div class="container">
                    ...
                    <div class="collapse navbar-collapse justify-content-end" id="navbarNav">
                        <ul class="navbar-nav">
                            <li class="nav-item">
                                <a class="nav-link mainlinks" href="index.php">Home</a>

                            </li>
                            <li class="nav-item">
                                <a class="nav-link mainlinks" href="about.php">About</a>

                            </li>
                            <li class="nav-item">
                                <a class="nav-link mainlinks" href="causes_we_support.php">Causes we support</a>

                            </li>
                            <li class="nav-item">
                                <a class="nav-link mainlinks" href="ourimpact.php">our impact</a>
                            ...
                            <li class="nav-item">
                                <a class="nav-link mainlinks" href="contact.php">contact us</a>
