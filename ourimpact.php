      ...
      <div class="container">
            <div class="row">
                  <div class="section-title text-center">
                        <h2 class="">Every number has a name. Every name has a story.</h2>
                  </div>
            ...
            <div class="row pt-5">
                  ...
                  <div class="col-lg-4 col-md-6 col-sm-6">
                        <div class="features-item-2 d-flex flex-row gap-4 p-3">
                              ...
                              <div class="features-content">
                                    <p>1000+</p>
                                    <h3>children equipped education</h3>
                              </div>
                        </div>
                  </div>
                  <div class="col-lg-4 col-md-6 col-sm-6">
                        <div class="features-item-2 d-flex flex-row gap-4 p-3">
                              <div class="features-icon">
                                    <img src="assets/img/houses.png" class="img-fluid sicon" alt="">
                              </div>
                              <div class="features-content">
                                    <p>20+</p>
                                    <h3>villages transformed
                                    </h3>
                              </div>
                        </div>
                  </div>
